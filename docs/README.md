...
**SAP MCP (Model Context Protocol) 开发包 - 让 AI 助手轻松调用 SAP 函数模块**

[English](./README.md) · [技术文档](./docs/TECHNICAL.md) · [问题反馈](https://github.com/MarkWuRY168/ABAP_MCP/issues)
...
- 🔌 **MCP 协议支持** - 完整实现 Model Context Protocol，让 AI 助手能调用 SAP 函数
- 🔄 **动态函数调用** - 无需开发新接口，动态调用已注册的函数模块
